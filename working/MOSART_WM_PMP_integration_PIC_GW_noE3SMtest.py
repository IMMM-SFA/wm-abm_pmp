...
logging.basicConfig(filename='/pic/scratch/yoon644/csmruns/wm_abm_run/run/app_noE3SMtest.log',level=logging.INFO)

logging.info('Successfully loaded all Python modules')

sys.stdout = open('/pic/scratch/yoon644/csmruns/wm_abm_run/run/python_stdout_noE3SM.log', 'w')
...
try:
    ...
    if int(month) == 1:
        ...
        if year_int<1950:  # If year is before 1950 (warm-up period), use the external baseline water demand files
            ...
            pic_input_dir = '/pic/scratch/yoon644/csmruns/wm_abm_run/run/'
        ...
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/gammas_total_20220227_protocol2.p', 'rb') as fp:
            gammas_total = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/net_prices_total_20220227_protocol2.p', 'rb') as fp:
            net_prices_total = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/alphas_total_20220227_protocol2.p', 'rb') as fp:
            alphas_total = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/net_prices_sw_20220227_protocol2.p', 'rb') as fp:
            net_prices_sw = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/alphas_sw_20220227_protocol2.p', 'rb') as fp:
            alphas_sw = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/gammas_sw_20220227_protocol2.p', 'rb') as fp:
            gammas_sw = pickle.load(fp)
        with open('/pic/projects/im3/wm/Jim/pmp_input_files/net_prices_gw_20220227_protocol2.p', 'rb') as fp:
